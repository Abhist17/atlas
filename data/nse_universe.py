"""NSE F&O universe — the ~180 liquid stocks that have active options and clean
intraday liquidity. This is the standard tradable set for an intraday screener
(far more useful than the full 2000+ list, most of which is illiquid).
"""
from __future__ import annotations

# NSE F&O single stocks (liquid, option-enabled). Kept as trading symbols.
FNO_UNIVERSE = [
    ...
    "TITAN", "TORNTPHARM", "TRENT", "TVSMOTOR", "UBL", "ULTRACEMCO", "UPL",
    "VEDL", "VOLTAS", "WIPRO", "ZYDUSLIFE",
]

# Broad market indices (yfinance ^ tickers handled separately)
INDEX_TICKERS = {
    "NIFTY 50": "^NSEI",
    "BANK NIFTY": "^NSEBANK",
